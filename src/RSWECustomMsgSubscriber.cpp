...
/**
 * @file RSWECustomMsgSubscriber.cpp
 *
 */

#include "RSWECustomMsgPubSubTypes.h"
    ...
    char **argv)
{
    ...
    RSWECustomMsgSubscriber *mysub = new RSWECustomMsgSubscriber();
    if (mysub->init())
    {
