...
/**
 * @file RSWECustomMsgPublisher.cpp
 *
 */
    ...
    char **argv)
{
    ...
    RSWECustomMsgPublisher *mypub = new RSWECustomMsgPublisher();
    if (mypub->init())
    {
